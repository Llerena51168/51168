...
export default class LogicListener extends antlr4.tree.ParseTreeListener {
	...
	// Enter a parse tree produced by LogicParser#primary.
	enterPrimary(ctx) {
	}

	// Exit a parse tree produced by LogicParser#primary.
	exitPrimary(ctx) {
	}
	...
	// Enter a parse tree produced by LogicParser#variable_char.
	enterVariable_char(ctx) {
	}

	// Exit a parse tree produced by LogicParser#variable_char.
	exitVariable_char(ctx) {
	}
